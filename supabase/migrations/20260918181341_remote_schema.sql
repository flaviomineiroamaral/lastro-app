...
CREATE SEQUENCE "public"."parametros_sistema_id_seq" AS integer INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1 NO CYCLE;

CREATE SEQUENCE "public"."planos_comerciais_id_seq" AS integer INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1 NO CYCLE;
...
CREATE TABLE "public"."assinaturas_b2c" (
  ...
  "ciclo_cobranca"          text                     NOT NULL DEFAULT 'mensal'::text,
  ...
  "serial_ativacao"         uuid                     NOT NULL DEFAULT extensions.uuid_generate_v4(),
  "serial_utilizado"        boolean                  NOT NULL DEFAULT false,
  CONSTRAINT "assinaturas_b2c_cpf_unique" UNIQUE (cpf),
  CONSTRAINT "assinaturas_b2c_status_check" CHECK ((status_assinatura = ANY (ARRAY['pendente'::text, 'ativa'::text, 'atrasada'::text, 'cancelada'::text])))
);

ALTER TABLE "public"."assinaturas_b2c"
...
CREATE TABLE "public"."codigos_parceria" (
  ...
  "ativo"               boolean                  DEFAULT true,
  "descricao"           text,
  "tipo_desconto"       text                     NOT NULL DEFAULT 'percentual'::text,
  "valor_desconto_fixo" numeric,
  "aplica_em"           text                     NOT NULL DEFAULT 'setup'::text,
  "data_validade"       timestamp with time zone,
  "limite_usos"         integer,
  CONSTRAINT "codigos_parceria_aplica_em_check" CHECK ((aplica_em = ANY (ARRAY['setup'::text, 'mensalidade'::text, 'ambos'::text]))),
  CONSTRAINT "codigos_parceria_percentual_desconto_check" CHECK (((percentual_desconto >= (0)::numeric) AND (percentual_desconto <= (100)::numeric))),
  CONSTRAINT "codigos_parceria_pkey" PRIMARY KEY (codigo),
  CONSTRAINT "codigos_parceria_tipo_check" CHECK ((tipo_desconto = ANY (ARRAY['percentual'::text, 'fixo'::text])))
);

ALTER TABLE "public"."codigos_parceria"
  ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE "public"."contas_bancarias" (
  ...
  CONSTRAINT "contas_bancarias_tipo_check"
    CHECK ((tipo = ANY (ARRAY['CORRENTE'::text, 'POUPANCA'::text, 'INVESTIMENTO'::text, 'CAIXA_FISICO'::text, 'VIRTUAL'::text, 'FUNDO_DE_RESERVA'::text, 'CARTAO'::text])))
);

ALTER TABLE "public"."contas_bancarias"
  ENABLE ROW LEVEL SECURITY;

CREATE TABLE "public"."contratos_b2b" (
  "created_at"             timestamp with time zone NOT NULL DEFAULT timezone('utc'::text, now()),
  "cnpj"                   text,
  "razao_social"           text,
  "cep"                    text,
  ...
  "valor_plano"            numeric,
  "isencao_setup"          boolean                  DEFAULT false,
  "valor_setup_base"       numeric                  DEFAULT 1597.00,
  "valor_setup_cobrado"    numeric                  DEFAULT 1597.00,
  "dia_vencimento"         integer                  DEFAULT 10,
  "codigo_parceria"        text,
  "codigo_parceria_status" text,
  "status_contrato"        text                     DEFAULT 'lead_recebido'::text,
  "assinafy_document_id"   text,
  "assinafy_signer_url"    text,
  "data_assinatura"        timestamp with time zone,
  "id_cobranca_setup"      text,
  "status_pagamento_setup" text                     DEFAULT 'pendente'::text,
  "link_boleto_setup"      text,
  "tipo_perfil"            text                     NOT NULL DEFAULT 'Família'::text,
  "serial_ativacao"        uuid                     NOT NULL DEFAULT extensions.uuid_generate_v4(),
  "serial_utilizado"       boolean                  NOT NULL DEFAULT false,
  "lead_id"                uuid,
  "organization_id"        uuid,
  "user_id"                uuid,
  CONSTRAINT "contratos_b2b_dia_vencimento_check" CHECK ((dia_vencimento = ANY (ARRAY[5, 10, 15, 20, 25]))),
  CONSTRAINT "contratos_b2b_pagamento_check" CHECK ((status_pagamento_setup = ANY (ARRAY['pendente'::text, 'pago'::text, 'expirado'::text, 'cancelado'::text]))),
  CONSTRAINT "contratos_b2b_serial_ativacao_key" UNIQUE (serial_ativacao),
  CONSTRAINT "contratos_b2b_status_check"
    CHECK
    ((status_contrato = ANY (ARRAY['lead_recebido'::text, 'pendente_geracao'::text, 'aguardando_permissao_wa'::text, 'link_enviado'::text, 'assinado'::text, 'cancelado'::text]))),
  CONSTRAINT "contratos_b2b_tipo_perfil_check" CHECK ((tipo_perfil = ANY (ARRAY['Igreja'::text, 'OSC/ONG'::text, 'Família'::text, 'Negócio'::text, 'Indústria'::text])))
);

ALTER TABLE "public"."contratos_b2b"
  ENABLE ROW LEVEL SECURITY;

CREATE TABLE "public"."historico_saldos" (
  "organization_id"   uuid                     NOT NULL,
  ...
  CONSTRAINT "historico_saldos_organization_id_conta_bancaria_id_mes_ano_key" UNIQUE (organization_id, conta_bancaria_id, mes, ano)
);

ALTER TABLE "public"."historico_saldos"
  ENABLE ROW LEVEL SECURITY;

CREATE TABLE "public"."leads_comercial" (
  ...
  "email"                 text,
  "tipo_perfil"           text,
  "ultima_interacao"      timestamp with time zone DEFAULT timezone('utc'::text, now()),
  "quantidade_conversoes" integer                  DEFAULT 1,
  CONSTRAINT "leads_comercial_pkey" PRIMARY KEY (id),
  CONSTRAINT "leads_comercial_tipo_perfil_check" CHECK ((tipo_perfil = ANY (ARRAY['Igreja'::text, 'OSC/ONG'::text, 'Família'::text, 'Negócio'::text, 'Indústria'::text])))
);

ALTER TABLE "public"."leads_comercial"
  ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE "public"."obrigacoes_recorrentes" (
  "organization_id"           uuid                     NOT NULL,
  ...
  "dias_antecedencia"         integer                  NOT NULL DEFAULT 20,
  "valor_estimado"            numeric(15,2)            NOT NULL DEFAULT 0.00,
  "ativo"                     boolean                  NOT NULL DEFAULT true,
  "ultima_competencia_gerada" date,
  "criado_em"                 timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT "chk_coerencia_periodicidade" CHECK ((((periodicidade = 'MENSAL'::text) AND (mes_vencimento IS NULL)) OR ((periodicidade = 'ANUAL'::text) AND (mes_vencimento IS
    NOT NULL)))),
...
ALTER TABLE "public"."obrigacoes_recorrentes"
  ENABLE ROW LEVEL SECURITY;

CREATE TABLE "public"."orcamentos_centro_custo" (
  "organization_id"       uuid                     NOT NULL,
  ...
  CONSTRAINT "uq_orcamento_cc_projeto" UNIQUE (organization_id, centro_custo_id, identificador_projeto, data_inicio, data_fim)
);

ALTER TABLE "public"."orcamentos_centro_custo"
  ENABLE ROW LEVEL SECURITY;

CREATE TABLE "public"."org_pulse" (
  "organization_id"    uuid                     NOT NULL,
  "ultima_atualizacao" timestamp with time zone DEFAULT now(),
  CONSTRAINT "org_pulse_pkey" PRIMARY KEY (organization_id)
);

ALTER TABLE "public"."org_pulse"
  ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE "public"."organization_members" (
  ...
  CONSTRAINT "organization_members_funcao_check"
    CHECK ((funcao = ANY (ARRAY['dono'::text, 'administrador'::text, 'operador'::text, 'leitor'::text, 'Dono'::text, 'Administrador'::text, 'Operador'::text, 'Leitor'::text]))),
...
CREATE TABLE "public"."parametros_sistema" (
  "id"          integer NOT NULL DEFAULT nextval('public.parametros_sistema_id_seq'::regclass),
  "chave"       text    NOT NULL,
  "valor"       numeric,
  "descricao"   text,
  "valor_texto" text,
  CONSTRAINT "parametros_sistema_chave_key" UNIQUE (chave),
...
CREATE TABLE "public"."plano_contas" (
  ...
  CONSTRAINT "plano_contas_tipo_check"
    CHECK ((tipo = ANY (ARRAY['RECEITA'::text, 'DESPESA'::text, 'ATIVO'::text, 'PASSIVO'::text, 'PL'::text, 'Receita'::text, 'Despesa'::text, 'Ativo'::text, 'Passivo'::text])))
);
...
CREATE TABLE "public"."planos_comerciais" (
  "id"                    integer                  NOT NULL DEFAULT nextval('public.planos_comerciais_id_seq'::regclass),
  "nome"                  text                     NOT NULL,
  "descricao_curta"       text,
  "limite_crs"            integer                  DEFAULT 1,
  "valor_mensal"          numeric                  NOT NULL,
  "ativo"                 boolean                  DEFAULT true,
  "ordem_exibicao"        integer                  DEFAULT 1,
  "tipo_publico"          text                     DEFAULT 'B2B'::text,
  "requer_setup"          boolean                  DEFAULT true,
  "requer_cnpj"           boolean                  DEFAULT true,
  "exibe_na_landing_page" boolean                  DEFAULT true,
  "gateway_plan_id"       text,
  "created_at"            timestamp with time zone DEFAULT timezone('utc'::text, now()),
  "updated_at"            timestamp with time zone DEFAULT timezone('utc'::text, now()),
  CONSTRAINT "planos_comerciais_nome_key" UNIQUE (nome),
  CONSTRAINT "planos_comerciais_pkey" PRIMARY KEY (id),
  CONSTRAINT "planos_comerciais_tipo_publico_check" CHECK ((tipo_publico = ANY (ARRAY['B2B'::text, 'B2C'::text])))
);
...
CREATE TABLE "public"."profiles" (
  ...
  "whatsapp"          text,
  "codigo_integracao" text                     DEFAULT SUBSTRING(md5((random())::text) FROM 1 FOR 8),
  CONSTRAINT "profiles_codigo_integracao_key" UNIQUE (codigo_integracao),
...
CREATE TABLE "public"."regras_categorizacao" (
  "id"              uuid                     NOT NULL DEFAULT gen_random_uuid(),
  "organization_id" uuid                     NOT NULL,
  "padrao_busca"    character varying(255)   NOT NULL,
  "tipo_leitura"    character varying(50)    DEFAULT 'CONTEM'::character varying,
  "plano_contas_id" uuid                     NOT NULL,
  "centro_custo_id" uuid                     NOT NULL,
  "prioridade"      integer                  DEFAULT 10,
  "hits_sucesso"    integer                  DEFAULT 0,
  "ativo"           boolean                  DEFAULT true,
  "criado_em"       timestamp with time zone DEFAULT now(),
  "atualizado_em"   timestamp with time zone DEFAULT now(),
  CONSTRAINT "regras_categorizacao_pkey" PRIMARY KEY (id),
  CONSTRAINT "regras_categorizacao_tipo_leitura_check"
    CHECK (((tipo_leitura)::text = ANY ((ARRAY['EXATA'::character varying, 'CONTEM'::character varying, 'INICIA_COM'::character varying, 'REGEX'::character varying])::text[])))
);

ALTER TABLE "public"."regras_categorizacao"
  ENABLE ROW LEVEL SECURITY;

CREATE TABLE "public"."transacoes_staging" (
  "id"                        uuid                     NOT NULL DEFAULT gen_random_uuid(),
  "organization_id"           uuid                     NOT NULL,
  "conta_bancaria_id"         uuid                     NOT NULL,
  "id_unico_banco"            character varying(255)   NOT NULL,
  "data_transacao"            timestamp with time zone NOT NULL,
  "valor"                     numeric(15,2)            NOT NULL,
  "descricao_original"        character varying(255)   NOT NULL,
  "tipo_operacao"             character varying(50)    NOT NULL,
  "dados_brutos_json"         jsonb,
  "status_importacao"         character varying(50)    DEFAULT 'PENDENTE'::character varying,
  "suggested_plano_contas_id" uuid,
  "suggested_centro_custo_id" uuid,
  "confidence_score"          integer                  DEFAULT 0,
  "criado_em"                 timestamp with time zone DEFAULT now(),
  CONSTRAINT "transacoes_staging_confidence_score_check" CHECK (((confidence_score >= 0) AND (confidence_score <= 100))),
  CONSTRAINT "transacoes_staging_pkey" PRIMARY KEY (id),
  CONSTRAINT "transacoes_staging_status_importacao_check"
    CHECK (((status_importacao)::text = ANY ((ARRAY['PENDENTE'::character varying, 'CONCILIADO'::character varying, 'DESCARTADO'::character varying])::text[]))),
  CONSTRAINT "transacoes_staging_tipo_operacao_check"
    CHECK (((tipo_operacao)::text = ANY ((ARRAY['DEBITO'::character varying, 'CREDITO'::character varying, 'TRANSFERENCIA'::character varying])::text[]))),
  CONSTRAINT "unq_transacao_staging" UNIQUE (conta_bancaria_id, id_unico_banco)
);

ALTER TABLE "public"."transacoes_staging"
  ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE "public"."transacoes" (
  ...
  CONSTRAINT "chk_transacao_paga_exige_conta" CHECK (((status = ANY (ARRAY['PENDENTE'::text, 'CANCELADO'::text])) OR ((status = 'CONCILIADO'::text) AND (conta_bancaria_id IS
    NOT NULL)))),
  CONSTRAINT "transacoes_id_banco_unico_org_key" UNIQUE (organization_id, id_unico_banco),
...
ALTER SEQUENCE "public"."planos_comerciais_id_seq" OWNED BY "public"."planos_comerciais"."id";

CREATE OR REPLACE FUNCTION monitor.log_table_dml()
  RETURNS TRIGGER
  LANGUAGE plpgsql
  SECURITY DEFINER
  SET search_path TO ''
...
CREATE OR REPLACE FUNCTION monitor.objects_without_dml_since (
...
CREATE OR REPLACE FUNCTION monitor.purge_audit_log (
...
CREATE OR REPLACE FUNCTION public.check_finance_usage()
  RETURNS TRIGGER
  LANGUAGE plpgsql
  AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.check_permite_lancamento()
  RETURNS TRIGGER
  LANGUAGE plpgsql
  AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.check_user_in_org (
  org_id uuid
)
  RETURNS boolean
  LANGUAGE plpgsql
...
CREATE OR REPLACE FUNCTION public.fn_alertas_dashboard (
  p_org_id uuid
)
  RETURNS TABLE (
    qtd_vencidas                     integer,
    valor_vencidas                   numeric,
    qtd_hoje                         integer,
    valor_hoje                       numeric,
    qtd_faturas_cartao               integer,
    valor_faturas_cartao             numeric,
    qtd_cartoes_vencidos             integer,
    valor_cartoes_vencidos           numeric,
    qtd_cartoes_hoje                 integer,
    valor_cartoes_hoje               numeric,
    qtd_cartoes_a_vencer             integer,
    valor_cartoes_a_vencer           numeric,
    proximo_melhor_dia_compra_global date,
    limite_restante_total            numeric,
    detalhes_cartoes                 jsonb
  )
  LANGUAGE plpgsql
  SECURITY DEFINER
  AS $function$BEGIN
...
CREATE OR REPLACE FUNCTION public.fn_aprender_com_conciliacao()
  RETURNS TRIGGER
  LANGUAGE plpgsql
  AS $function$
DECLARE
    texto_limpo VARCHAR;
BEGIN
    -- O gatilho só atua quando a transação passa de PENDENTE para CONCILIADO
    IF OLD.status_importacao = 'PENDENTE' AND NEW.status_importacao = 'CONCILIADO' THEN
        
        -- Cenario 1: O usuário aprovou a sugestão sem alterar nada (Reforço positivo)
        IF NEW.suggested_plano_contas_id = OLD.suggested_plano_contas_id AND 
           NEW.suggested_centro_custo_id = OLD.suggested_centro_custo_id AND 
           NEW.confidence_score > 0 THEN
           
           -- Incrementa a força da regra que gerou a sugestão 
           -- (Nota: Para este update funcionar, a tabela staging precisaria guardar o ID da regra que fez a sugestão,
           --  o que pode ser adicionado como a coluna 'regra_aplicada_id' posteriormente)
           NULL; 
           
        -- Cenario 2: O usuário alterou a sugestão na interface (Correção e Criação de Regra)
        ELSIF (NEW.suggested_plano_contas_id != OLD.suggested_plano_contas_id) OR 
              (OLD.suggested_plano_contas_id IS NULL AND NEW.suggested_plano_contas_id IS NOT NULL) THEN
            
            texto_limpo := UPPER(TRIM(REGEXP_REPLACE(NEW.descricao_original, '\s+', ' ', 'g')));
            
            -- Cria uma nova regra provisória baseada na descrição original
            INSERT INTO public.regras_categorizacao (
                organization_id, padrao_busca, tipo_leitura, 
                plano_contas_id, centro_custo_id, prioridade, hits_sucesso
            ) VALUES (
                NEW.organization_id, texto_limpo, 'EXATA', 
                NEW.suggested_plano_contas_id, NEW.suggested_centro_custo_id, 50, 1
            )
            -- Se a regra exata já existir, não tenta duplicar
...
CREATE OR REPLACE FUNCTION public.fn_aprovar_item_staging (
  p_staging_id uuid
)
  RETURNS boolean
  LANGUAGE plpgsql
...
BEGIN
    ...
    SELECT 
        ...
        descricao_original,
        tipo_operacao,
        suggested_plano_contas_id,
        suggested_centro_custo_id,
        'CONCILIADO',
        data_transacao::DATE
    FROM public.transacoes_staging
    WHERE id = p_staging_id AND status_importacao = 'PENDENTE';

    -- 2. Atualiza a staging (isso dispara o gatilho de aprendizado automaticamente)
    UPDATE public.transacoes_staging
    SET status_importacao = 'CONCILIADO'
...
CREATE OR REPLACE FUNCTION public.fn_aprovar_lote_staging (
  p_org_id         uuid,
  p_conta_id       uuid,
  p_min_confidence integer DEFAULT 90
)
  RETURNS integer
  LANGUAGE plpgsql
  AS $function$
...
BEGIN
    -- 1. Move os dados da staging para a tabela oficial
    INSERT INTO public.transacoes (
        organization_id,
        conta_bancaria_id,
        id_unico_banco,
    ...
    WHERE organization_id = p_org_id 
      ...
      AND status_importacao = 'PENDENTE'
      AND confidence_score >= p_min_confidence
      AND suggested_plano_contas_id IS NOT NULL 
      AND suggested_centro_custo_id IS NOT NULL;

    -- Captura quantas linhas foram movidas
    GET DIAGNOSTICS linhas_afetadas = ROW_COUNT;

    -- 2. Atualiza o status na staging para não serem listadas novamente
    UPDATE public.transacoes_staging
    SET status_importacao = 'CONCILIADO'
    WHERE organization_id = p_org_id 
      AND conta_bancaria_id = p_conta_id
...
CREATE OR REPLACE FUNCTION public.fn_autocura_saldos()
  RETURNS TRIGGER
  LANGUAGE plpgsql
  SECURITY DEFINER
  AS $function$
...
CREATE OR REPLACE FUNCTION public.fn_descartar_item_staging (
  p_staging_id uuid
)
  RETURNS boolean
  LANGUAGE plpgsql
...
BEGIN
    UPDATE public.transacoes_staging
    SET status_importacao = 'DESCARTADO'
    WHERE id = p_staging_id;
...
CREATE OR REPLACE FUNCTION public.fn_detalhe_cr (
  p_org_id      uuid,
  p_cr_id       uuid,
  p_data_inicio date,
  p_data_fim    date
...
CREATE OR REPLACE FUNCTION public.fn_gerar_transacoes_recorrentes()
  RETURNS void
  LANGUAGE plpgsql
  AS $function$DECLARE
    reg RECORD;
...
CREATE OR REPLACE FUNCTION public.fn_grafico_dfc_diario (
  p_org_id      uuid,
  p_data_inicio date,
  p_data_fim    date
)
...
CREATE OR REPLACE FUNCTION public.fn_grafico_dfc_predicao (
  p_organization_id uuid,
  p_dias_historico  integer DEFAULT 56,
  p_dias_predicao   integer DEFAULT 14
)
  RETURNS TABLE (
    dia                date,
    total_entradas     numeric,
...
CREATE OR REPLACE FUNCTION public.fn_grafico_dre_diario (
  p_org_id      uuid,
  p_data_inicio date,
  p_data_fim    date
)
...
CREATE OR REPLACE FUNCTION public.fn_inferir_categorizacao_staging()
  RETURNS TRIGGER
  LANGUAGE plpgsql
  AS $function$
DECLARE
    ...
    texto_limpo VARCHAR;
BEGIN
    -- 1. Sanitização Textual: Caixa alta e remoção de espaços duplos/excessivos
    texto_limpo := UPPER(TRIM(REGEXP_REPLACE(NEW.descricao_original, '\s+', ' ', 'g')));

    -- 2. Loop de Varredura: Busca a melhor regra (Maior prioridade e Padrão mais longo vencem)
    FOR regra IN 
        SELECT id, plano_contas_id, centro_custo_id, tipo_leitura, padrao_busca
        FROM public.regras_categorizacao
        WHERE organization_id = NEW.organization_id AND ativo = TRUE
        ORDER BY prioridade DESC, LENGTH(padrao_busca) DESC
    LOOP
        -- 3. Avaliação Dinâmica de Acoplamento
        IF regra.tipo_leitura = 'EXATA' AND texto_limpo = UPPER(regra.padrao_busca) THEN
            NEW.suggested_plano_contas_id := regra.plano_contas_id;
            NEW.suggested_centro_custo_id := regra.centro_custo_id;
            NEW.confidence_score := 95; -- Certeza quase absoluta
            EXIT; -- Interrompe a busca assim que acha o match perfeito
            
        ELSIF regra.tipo_leitura = 'INICIA_COM' AND texto_limpo LIKE UPPER(regra.padrao_busca) || '%' THEN
            NEW.suggested_plano_contas_id := regra.plano_contas_id;
            NEW.suggested_centro_custo_id := regra.centro_custo_id;
            NEW.confidence_score := 85;
            EXIT;
            
        ELSIF regra.tipo_leitura = 'CONTEM' AND texto_limpo LIKE '%' || UPPER(regra.padrao_busca) || '%' THEN
            NEW.suggested_plano_contas_id := regra.plano_contas_id;
            NEW.suggested_centro_custo_id := regra.centro_custo_id;
            NEW.confidence_score := 75; -- Necessita de atenção na triagem humana
            EXIT;
            
        ELSIF regra.tipo_leitura = 'REGEX' AND texto_limpo ~* regra.padrao_busca THEN
            NEW.suggested_plano_contas_id := regra.plano_contas_id;
            NEW.suggested_centro_custo_id := regra.centro_custo_id;
            NEW.confidence_score := 90;
            EXIT;
        END IF;
    END LOOP;

    -- 4. Tratamento de Falha (Se não achou nada, o score é zero)
    IF NEW.suggested_plano_contas_id IS NULL THEN
...
CREATE OR REPLACE FUNCTION public.fn_listar_obrigacoes_recorrentes (
  p_org_id        uuid,
...
CREATE OR REPLACE FUNCTION public.fn_obter_contrato_b2b_by_serial (
  p_serial uuid
)
  RETURNS TABLE (
    contrato_id  uuid,
...
BEGIN
    ...
    SELECT
        ...
        c.razao_social,
        c.tipo_perfil
    FROM public.contratos_b2b c
    WHERE c.serial_ativacao = p_serial
      AND c.serial_utilizado = false
      AND c.status_contrato = 'assinado';
END;
$function$;

CREATE OR REPLACE FUNCTION public.fn_relatorio_cr_analitico (
  p_org_id      uuid,
  p_data_inicio date,
  p_data_fim    date
)
  RETURNS TABLE (
    ...
    is_padrao               boolean,
    ativo                   boolean,
    calc_despesa            numeric,
    calc_receita            numeric,
    calc_subsidio_recebido  numeric,
    calc_subsidio_concedido numeric,
    calc_subsidio           numeric,
    saldo_caixa             numeric,
    autossuficiencia        numeric
  )
  LANGUAGE plpgsql
  SECURITY DEFINER
  AS $function$
...
CREATE OR REPLACE FUNCTION public.fn_relatorio_cr_sintetico (
  ...
  RETURNS TABLE (
    ...
    subsidios_concedidos numeric,
    subsidios_recebidos  numeric,
    subsidios_alocados   numeric,
    despesas_proprias    numeric,
    saldo_disponivel     numeric,
    saude_orcamentaria   numeric
  )
  LANGUAGE plpgsql
  SECURITY DEFINER
  AS $function$
...
CREATE OR REPLACE FUNCTION public.fn_relatorio_cr_sintetico_por_id (
  p_org_id          uuid,
  p_data_inicio     date,
  p_data_fim        date,
...
CREATE OR REPLACE FUNCTION public.fn_relatorio_dfc_analitico (
  p_org_id      uuid,
  p_data_inicio date,
  p_data_fim    date
)
...
CREATE OR REPLACE FUNCTION public.fn_relatorio_dfc_sintetico (
  p_org_id      uuid,
  p_data_inicio date,
  p_data_fim    date
)
...
CREATE OR REPLACE FUNCTION public.fn_relatorio_dre_analitico (
  p_org_id      uuid,
  p_data_inicio date,
  p_data_fim    date
)
...
CREATE OR REPLACE FUNCTION public.fn_resumo_conciliacao_dashboard (
  p_org_id      uuid,
  p_data_inicio timestamp with time zone,
  p_data_fim    timestamp with time zone
)
  RETURNS TABLE (
    saldo_inicial_historico numeric,
    resultado_operacional   numeric,
    disponibilidade_real    numeric
  )
  LANGUAGE plpgsql
  SECURITY DEFINER
  AS $function$
...
CREATE OR REPLACE FUNCTION public.fn_update_org_pulse()
  RETURNS TRIGGER
  LANGUAGE plpgsql
  SECURITY DEFINER
  AS $function$
...
CREATE OR REPLACE FUNCTION public.fn_validar_conta_analitica()
  RETURNS TRIGGER
  LANGUAGE plpgsql
  AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.gerar_proximo_codigo_subconta (
  p_organization_id uuid,
  p_codigo_pai      text
)
  RETURNS text
...
CREATE OR REPLACE FUNCTION public.handle_new_user_homolog()
  RETURNS TRIGGER
  LANGUAGE plpgsql
  SECURITY DEFINER
  AS $function$
...
BEGIN
    ...
    -- Vincula à organização de homologação
    INSERT INTO public.organization_members (organization_id, profile_id, entrada_em)
    VALUES (org_id, NEW.id, now())
    ON CONFLICT DO NOTHING;
...
CREATE OR REPLACE FUNCTION public.manter_unico_centro_custo_padrao()
  RETURNS TRIGGER
  LANGUAGE plpgsql
  AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.manter_unico_fundo_geral()
  RETURNS TRIGGER
  LANGUAGE plpgsql
  SECURITY DEFINER
  AS $function$
...
CREATE OR REPLACE FUNCTION public.obter_cache_centros_custo (
  p_org_id uuid
)
  RETURNS TABLE (
    id              uuid,
...
CREATE OR REPLACE FUNCTION public.obter_cache_contas_bancarias (
  p_org_id uuid
)
  RETURNS TABLE (
    id             uuid,
...
CREATE OR REPLACE FUNCTION public.obter_cache_membros_light (
  p_org_id uuid
)
  RETURNS TABLE (
    id            uuid,
...
CREATE OR REPLACE FUNCTION public.obter_cache_plano_contas (
  p_org_id uuid
)
  RETURNS TABLE (
    id                 uuid,
...
CREATE OR REPLACE FUNCTION public.obter_detalhe_transacao_otimizado (
  p_org_id       uuid,
  p_transacao_id uuid
)
  RETURNS TABLE (
...
CREATE OR REPLACE FUNCTION public.obter_detalhes_dfc_categoria (
  p_org_id       uuid,
  p_data_inicio  date,
  p_data_fim     date,
  p_categoria_id uuid
...
CREATE OR REPLACE FUNCTION public.obter_detalhes_dre_categoria (
  p_org_id       uuid,
  p_data_inicio  date,
  p_data_fim     date,
  p_categoria_id uuid
...
CREATE OR REPLACE FUNCTION public.obter_extrato_por_periodo (
  ...
  RETURNS TABLE (
    transacao_id      uuid,
    data_linha_tempo  timestamp with time zone,
    descricao         text,
    categoria_nome    text,
    valor_movimento   numeric,
...
CREATE OR REPLACE FUNCTION public.obter_pendencias_fechamento_mes (
  p_org_id   uuid,
  p_data_fim timestamp with time zone
)
  RETURNS TABLE (
    total_pagar_aberto   numeric,
    total_receber_aberto numeric
  )
  LANGUAGE plpgsql
  SECURITY DEFINER
  AS $function$
...
CREATE OR REPLACE FUNCTION public.obter_projecao_titulos_retroativa (
  p_org_id   uuid,
  p_data_fim timestamp with time zone
)
  RETURNS TABLE (
...
CREATE OR REPLACE FUNCTION public.obter_saldos_contas (
  p_org_id uuid
)
  RETURNS TABLE (
    conta_id       uuid,
...
CREATE OR REPLACE FUNCTION public.populate_organization_defaults()
  RETURNS TRIGGER
  LANGUAGE plpgsql
  SECURITY DEFINER
  AS $function$BEGIN
...
CREATE OR REPLACE FUNCTION public.sanitize_transacao_data()
  RETURNS TRIGGER
  LANGUAGE plpgsql
  AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.validar_serial (
  p_serial_ativacao uuid
)
  RETURNS json
  LANGUAGE plpgsql
  SECURITY DEFINER
...
DECLARE
    v_resultado json;
BEGIN
    -- Tenta encontrar o serial na tabela corporativa (B2B)
    SELECT json_build_object(
        ...
        'serial_utilizado', serial_utilizado,
        'tabela_origem', 'contratos_b2b'
    ) INTO v_resultado
    FROM public.contratos_b2b
    WHERE serial_ativacao = p_serial_ativacao;

    -- Se encontrou no B2B, interrompe e devolve o JSON
    IF FOUND THEN
        RETURN v_resultado;
    END IF;

    -- Caso contrário, busca na tabela de uso pessoal (B2C)
    SELECT json_build_object(
        'valido', true,
        'id_registro', id,
        ...
        'tipo_perfil', 'Família',
        'serial_utilizado', serial_utilizado,
        'tabela_origem', 'assinaturas_b2c'
    ) INTO v_resultado
    FROM public.assinaturas_b2c
    WHERE serial_ativacao = p_serial_ativacao;

    -- Se encontrou no B2C, interrompe e devolve o JSON
    IF FOUND THEN
        RETURN v_resultado;
    END IF;

    -- Se o UUID não existe em nenhuma tabela, devolve falha lógica
    RETURN json_build_object(
        'valido', false,
        'mensagem', 'Serial de ativação inválido ou inexistente.'
    );
END;
$function$;

CREATE OR REPLACE FUNCTION public.validate_transacao_logic()
  RETURNS TRIGGER
  LANGUAGE plpgsql
  AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.verificar_pai_tem_transacoes (
  p_organization_id uuid,
  p_codigo_filho    text
)
  RETURNS boolean
...
ALTER TABLE "public"."contratos_b2b"
  ADD CONSTRAINT "contratos_b2b_lead_id_fkey" FOREIGN KEY (lead_id) REFERENCES public.leads_comercial(id) ON DELETE SET NULL;

ALTER TABLE "public"."assinaturas_b2c"
  ADD CONSTRAINT "assinaturas_b2c_plano_id_fkey" FOREIGN KEY (plano_id) REFERENCES public.planos_comerciais(id) ON DELETE RESTRICT;

ALTER TABLE "public"."organizations"
  ADD CONSTRAINT "organizations_plano_id_fkey" FOREIGN KEY (plano_id) REFERENCES public.planos_comerciais(id);

ALTER TABLE "public"."profiles"
  ADD CONSTRAINT "profiles_id_fkey" FOREIGN KEY (id) REFERENCES auth.users(id) ON DELETE CASCADE;

ALTER TABLE "public"."assinaturas_b2c"
  ADD CONSTRAINT "assinaturas_b2c_user_id_fkey" FOREIGN KEY (user_id) REFERENCES public.profiles(id) ON DELETE RESTRICT;

ALTER TABLE "public"."contratos_b2b"
  ADD CONSTRAINT "contratos_b2b_user_id_fkey" FOREIGN KEY (user_id) REFERENCES public.profiles(id) ON DELETE SET NULL;
...
CREATE VIEW "monitor"."function_usage_public" AS  SELECT n.nspname AS schema_name,
...
CREATE VIEW "monitor"."last_usage_by_table" AS  SELECT schema_name,
...
CREATE VIEW "monitor"."objects_without_dml_last_30d" AS  WITH public_tables AS (
...
CREATE VIEW "monitor"."recent_activity" AS  SELECT occurred_at,
    schema_name,
    object_name,
    operation,
    role_name,
...
CREATE VIEW "monitor"."table_usage_public" AS  SELECT schemaname,
...
CREATE VIEW "monitor"."triggers_public" AS  SELECT n.nspname AS table_schema,
...
CREATE VIEW "monitor"."unused_tables_public" AS  SELECT schemaname,
    relname AS table_name,
    seq_scan,
    idx_scan,
    GREATEST(last_seq_scan, last_idx_scan) AS last_read_at
...
CREATE VIEW "monitor"."views_public" AS  SELECT schemaname,
    viewname,
...
CREATE INDEX idx_regras_padrao ON public.regras_categorizacao USING btree (organization_id, ativo);

CREATE INDEX idx_staging_status ON public.transacoes_staging USING btree (status_importacao, organization_id);

CREATE INDEX idx_transacoes_alerta_vencimento ON public.transacoes USING btree (organization_id, data_vencimento, tipo_operacao)
  WHERE (status <> 'CONCILIADO'::text);
...
CREATE TRIGGER on_auth_user_created_homolog
  AFTER INSERT ON auth.users
  FOR EACH ROW
  EXECUTE FUNCTION public.handle_new_user_homolog();

CREATE TRIGGER trg_audit_dml_assinaturas_b2c
  AFTER INSERT OR DELETE OR UPDATE ON public.assinaturas_b2c
  FOR EACH STATEMENT
  EXECUTE FUNCTION monitor.log_table_dml();

CREATE TRIGGER tg_prevent_delete_centro_custo
  BEFORE DELETE ON public.centros_custo
  FOR EACH ROW
  EXECUTE FUNCTION public.check_finance_usage();

CREATE TRIGGER trg_audit_dml_centros_custo
  AFTER INSERT OR DELETE OR UPDATE ON public.centros_custo
  FOR EACH STATEMENT
  EXECUTE FUNCTION monitor.log_table_dml();

CREATE TRIGGER trg_unico_fundo_geral
  BEFORE INSERT OR UPDATE ON public.centros_custo
  FOR EACH ROW
  EXECUTE FUNCTION public.manter_unico_fundo_geral();

CREATE TRIGGER trg_unico_padrao
  BEFORE INSERT OR UPDATE ON public.centros_custo
  FOR EACH ROW
  EXECUTE FUNCTION public.manter_unico_centro_custo_padrao();

CREATE TRIGGER trg_audit_dml_contas_bancarias
  AFTER INSERT OR DELETE OR UPDATE ON public.contas_bancarias
  FOR EACH STATEMENT
  EXECUTE FUNCTION monitor.log_table_dml();

CREATE TRIGGER trg_audit_dml_historico_saldos
  AFTER INSERT OR DELETE OR UPDATE ON public.historico_saldos
  FOR EACH STATEMENT
  EXECUTE FUNCTION monitor.log_table_dml();

CREATE TRIGGER trg_audit_dml_membros
  AFTER INSERT OR DELETE OR UPDATE ON public.membros
  FOR EACH STATEMENT
  EXECUTE FUNCTION monitor.log_table_dml();

CREATE TRIGGER trg_audit_dml_obrigacoes_recorrentes
  AFTER INSERT OR DELETE OR UPDATE ON public.obrigacoes_recorrentes
  FOR EACH STATEMENT
  EXECUTE FUNCTION monitor.log_table_dml();

CREATE TRIGGER trg_audit_dml_orcamentos_centro_custo
  AFTER INSERT OR DELETE OR UPDATE ON public.orcamentos_centro_custo
  FOR EACH STATEMENT
  EXECUTE FUNCTION monitor.log_table_dml();

CREATE TRIGGER trg_audit_dml_org_pulse
  AFTER INSERT OR DELETE OR UPDATE ON public.org_pulse
  FOR EACH STATEMENT
  EXECUTE FUNCTION monitor.log_table_dml();

CREATE TRIGGER trg_audit_dml_organization_members
  AFTER INSERT OR DELETE OR UPDATE ON public.organization_members
  FOR EACH STATEMENT
  EXECUTE FUNCTION monitor.log_table_dml();

CREATE TRIGGER on_org_created_populate_defaults
  AFTER INSERT ON public.organizations
  FOR EACH ROW
  EXECUTE FUNCTION public.populate_organization_defaults();

CREATE TRIGGER trg_audit_dml_organizations
  AFTER INSERT OR DELETE OR UPDATE ON public.organizations
  FOR EACH STATEMENT
  EXECUTE FUNCTION monitor.log_table_dml();

CREATE TRIGGER tg_prevent_delete_plano_contas
  BEFORE DELETE ON public.plano_contas
  FOR EACH ROW
  EXECUTE FUNCTION public.check_finance_usage();

CREATE TRIGGER trg_audit_dml_plano_contas
  AFTER INSERT OR DELETE OR UPDATE ON public.plano_contas
  FOR EACH STATEMENT
  EXECUTE FUNCTION monitor.log_table_dml();

CREATE TRIGGER trg_audit_dml_profiles
  AFTER INSERT OR DELETE OR UPDATE ON public.profiles
  FOR EACH STATEMENT
  EXECUTE FUNCTION monitor.log_table_dml();

CREATE TRIGGER tg_sanitize_transacao
  BEFORE INSERT OR UPDATE ON public.transacoes
  FOR EACH ROW
  EXECUTE FUNCTION public.sanitize_transacao_data();

CREATE TRIGGER tg_set_transacao_audit
  BEFORE INSERT ON public.transacoes
  FOR EACH ROW
  EXECUTE FUNCTION public.set_created_by();

CREATE TRIGGER tg_validate_finance_logic
  BEFORE INSERT OR UPDATE ON public.transacoes
  FOR EACH ROW
  EXECUTE FUNCTION public.validate_transacao_logic();

CREATE TRIGGER tr_impedir_lancamento_sintetico
  BEFORE INSERT OR UPDATE ON public.transacoes
  FOR EACH ROW
  EXECUTE FUNCTION public.fn_validar_conta_analitica();

CREATE TRIGGER trg_audit_dml_transacoes
  AFTER INSERT OR DELETE OR UPDATE ON public.transacoes
  FOR EACH STATEMENT
  EXECUTE FUNCTION monitor.log_table_dml();

CREATE TRIGGER trg_autocura_saldos
  AFTER INSERT OR DELETE OR UPDATE ON public.transacoes
  FOR EACH ROW
  EXECUTE FUNCTION public.fn_autocura_saldos();

CREATE TRIGGER trg_pulse_transacoes
  AFTER INSERT OR DELETE OR UPDATE ON public.transacoes
  FOR EACH ROW
  EXECUTE FUNCTION public.fn_update_org_pulse();

CREATE TRIGGER trg_aprender_staging
  AFTER UPDATE OF status_importacao ON public.transacoes_staging
  FOR EACH ROW
  EXECUTE FUNCTION public.fn_aprender_com_conciliacao();

CREATE TRIGGER trg_inferir_staging
  BEFORE INSERT ON public.transacoes_staging
  FOR EACH ROW
  EXECUTE FUNCTION public.fn_inferir_categorizacao_staging();

CREATE POLICY "Gestão de centros por org" ON "public"."centros_custo"
  FOR ALL
  TO PUBLIC
  USING (public.check_user_in_org(organization_id));

CREATE POLICY "Gestão de contas por org" ON "public"."contas_bancarias"
  FOR ALL
  TO PUBLIC
  USING (public.check_user_in_org(organization_id));

CREATE POLICY "Gestão de histórico por org" ON "public"."historico_saldos"
  FOR ALL
  TO PUBLIC
  USING (public.check_user_in_org(organization_id));

CREATE POLICY "Gestão de membros por org" ON "public"."membros"
  FOR ALL
  TO PUBLIC
  USING (public.check_user_in_org(organization_id));

CREATE POLICY "Permissao_Total_Autenticado" ON "public"."obrigacoes_recorrentes"
  FOR ALL
  TO "authenticated"
  USING ((auth.uid() IS NOT NULL))
  WITH CHECK ((auth.uid() IS NOT NULL));

CREATE POLICY "Isolamento por Org Pulse" ON "public"."org_pulse"
  FOR SELECT
  TO PUBLIC
  USING (public.check_user_in_org(organization_id));

CREATE POLICY "Membros veem membros da mesma org" ON "public"."organization_members"
  FOR SELECT
  TO PUBLIC
  USING (public.check_user_in_org(organization_id));

CREATE POLICY "Gestão de plano de contas por org" ON "public"."plano_contas"
  FOR ALL
  TO PUBLIC
  USING (public.check_user_in_org(organization_id));

CREATE POLICY "Permitir leitura publica de planos" ON "public"."planos_comerciais"
  FOR SELECT
  TO PUBLIC
  USING (true);

CREATE POLICY "Permitir Update no proprio perfil" ON "public"."profiles"
  FOR UPDATE
  TO PUBLIC
  USING ((auth.uid() = id));
...
CREATE POLICY "RLS_profiles_equipa" ON "public"."profiles"
  FOR SELECT
  TO PUBLIC
  USING ((id IN ( SELECT organization_members.profile_id
   FROM public.organization_members
...
CREATE POLICY "Gestão de transações por org" ON "public"."transacoes"
  FOR ALL
  TO PUBLIC
  USING (public.check_user_in_org(organization_id))
  WITH CHECK (public.check_user_in_org(organization_id));

CREATE POLICY "Isolamento de Organização - Leitura" ON "public"."transacoes"
  FOR SELECT
  TO PUBLIC
...
CREATE POLICY "Isolamento por Organização (Transacoes)" ON "public"."transacoes"
  FOR SELECT
  TO "authenticated"
  USING (public.check_user_in_org(organization_id));

CREATE POLICY "Isolar_Orgs_Delete" ON "public"."transacoes"
  FOR DELETE
  TO PUBLIC
  USING (public.check_user_in_org(organization_id));

CREATE POLICY "Isolar_Orgs_Insert" ON "public"."transacoes"
  FOR INSERT
  TO PUBLIC
  WITH CHECK (public.check_user_in_org(organization_id));

CREATE POLICY "Isolar_Orgs_Select" ON "public"."transacoes"
  FOR SELECT
  TO PUBLIC
  USING (public.check_user_in_org(organization_id));

CREATE POLICY "Isolar_Orgs_Update" ON "public"."transacoes"
  FOR UPDATE
  TO PUBLIC
  USING (public.check_user_in_org(organization_id));
...
GRANT EXECUTE ON FUNCTION "monitor"."log_table_dml"() TO "postgres";

GRANT EXECUTE ON FUNCTION "monitor"."objects_without_dml_since"(integer) TO "postgres";

GRANT EXECUTE ON FUNCTION "monitor"."purge_audit_log"(integer) TO "postgres";

GRANT EXECUTE ON FUNCTION "public"."add_organization_member"(uuid, uuid, text) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."check_finance_usage"() TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."check_permite_lancamento"() TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."check_user_in_org"(uuid) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."create_my_organization"(text, text, uuid) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_alertas_dashboard"(uuid) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_aprender_com_conciliacao"() TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_aprovar_item_staging"(uuid) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_aprovar_lote_staging"(uuid, uuid, integer) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_autocura_saldos"() TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_descartar_item_staging"(uuid) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_detalhe_cr"(uuid, uuid, date, date) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_gerar_transacoes_recorrentes"() TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_grafico_dfc_diario"(uuid, date, date) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_grafico_dfc_predicao"(uuid, integer, integer) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_grafico_dre_diario"(uuid, date, date) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_inferir_categorizacao_staging"() TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_listar_obrigacoes_recorrentes"(uuid, boolean) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_obter_contrato_b2b_by_serial"(uuid) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_relatorio_cr_analitico"(uuid, date, date) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_relatorio_cr_sintetico"(uuid, date, date) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_relatorio_cr_sintetico_por_id"(uuid, date, date, uuid) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_relatorio_dfc_analitico"(uuid, date, date) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_relatorio_dfc_sintetico"(uuid, date, date) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_relatorio_dre_analitico"(uuid, date, date) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_relatorio_dre_sintetico"(uuid, date, date) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE
  ON FUNCTION "public"."fn_resumo_conciliacao_dashboard"(uuid, timestamp WITH time zone, timestamp WITH time zone)
  TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_resumo_contas_pagar_receber"(uuid) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_resumo_saude_cr"(uuid, date, date) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_update_org_pulse"() TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."fn_validar_conta_analitica"() TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."gerar_proximo_codigo_subconta"(uuid, text) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."handle_new_user"() TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."handle_new_user_homolog"() TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."is_org_member"(uuid) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."manter_unico_centro_custo_padrao"() TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."manter_unico_fundo_geral"() TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."obter_cache_centros_custo"(uuid) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."obter_cache_contas_bancarias"(uuid) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."obter_cache_membros_light"(uuid) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."obter_cache_plano_contas"(uuid) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."obter_detalhe_transacao_otimizado"(uuid, uuid) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."obter_detalhes_dfc_categoria"(uuid, date, date, uuid) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."obter_detalhes_dre_categoria"(uuid, date, date, uuid) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE
  ON FUNCTION "public"."obter_extrato_por_periodo"(uuid, uuid, timestamp WITH time zone, timestamp WITH time zone)
  TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."obter_pendencias_fechamento_mes"(uuid, timestamp WITH time zone) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."obter_projecao_titulos_retroativa"(uuid, timestamp WITH time zone) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."obter_saldo_total_org"(uuid) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."obter_saldos_contas"(uuid) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE
  ON FUNCTION "public"."obter_saldos_contas_por_periodo"(uuid, timestamp WITH time zone, timestamp WITH time zone)
  TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."populate_organization_defaults"() TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."rls_auto_enable"() TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."sanitize_transacao_data"() TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."set_created_by"() TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."uuid_generate_v7"() TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."validar_serial"(uuid) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."validate_transacao_logic"() TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT EXECUTE ON FUNCTION "public"."verificar_pai_tem_transacoes"(uuid, text) TO PUBLIC, "anon", "authenticated", "postgres", "service_role";

GRANT CREATE, USAGE ON SCHEMA "monitor" TO "postgres";

GRANT SELECT, UPDATE, USAGE ON SEQUENCE "public"."parametros_sistema_id_seq" TO "anon", "authenticated", "postgres", "service_role";

GRANT SELECT, UPDATE, USAGE ON SEQUENCE "public"."planos_comerciais_id_seq" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "monitor"."audit_log" TO "postgres";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."assinaturas_b2c" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."centros_custo" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."codigos_parceria" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."contas_bancarias" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."contratos_b2b" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."historico_saldos" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."leads_comercial" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."membros" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."obrigacoes_recorrentes" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."orcamentos_centro_custo" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."org_pulse" TO "anon", "authenticated", "postgres", "service_role";
...
GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."parametros_sistema" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."plano_contas" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."planos_comerciais" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."profiles" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."regras_categorizacao" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."transacoes" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."transacoes_staging" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "monitor"."function_usage_public" TO "postgres";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "monitor"."last_usage_by_table" TO "postgres";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "monitor"."objects_without_dml_last_30d" TO "postgres";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "monitor"."recent_activity" TO "postgres";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "monitor"."table_usage_public" TO "postgres";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "monitor"."triggers_public" TO "postgres";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "monitor"."unused_tables_public" TO "postgres";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "monitor"."views_public" TO "postgres";

ALTER TABLE "public"."assinaturas_b2c"
  ADD COLUMN "id" uuid NOT NULL DEFAULT public.uuid_generate_v7();

ALTER TABLE "public"."assinaturas_b2c"
  ADD CONSTRAINT "assinaturas_b2c_pkey" PRIMARY KEY (id);
...
ALTER TABLE "public"."regras_categorizacao"
  ADD CONSTRAINT "regras_categorizacao_centro_custo_id_fkey" FOREIGN KEY (centro_custo_id) REFERENCES public.centros_custo(id);

ALTER TABLE "public"."transacoes"
  ADD CONSTRAINT "transacoes_centro_custo_id_fkey" FOREIGN KEY (centro_custo_id) REFERENCES public.centros_custo(id);

ALTER TABLE "public"."transacoes_staging"
  ADD CONSTRAINT "transacoes_staging_suggested_centro_custo_id_fkey" FOREIGN KEY (suggested_centro_custo_id) REFERENCES public.centros_custo(id);
...
CREATE VIEW "public"."view_saldos_contas" WITH (security_invoker=true) AS  WITH extrato_bruto AS (
...
CREATE VIEW "public"."vw_saldo_total_org" WITH (security_invoker=true) AS  SELECT organization_id,
...
GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."view_saldos_contas" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."vw_saldo_total_org" TO "anon", "authenticated", "postgres", "service_role";

ALTER TABLE "public"."contratos_b2b"
  ADD COLUMN "id" uuid NOT NULL DEFAULT public.uuid_generate_v7();

ALTER TABLE "public"."contratos_b2b"
  ADD CONSTRAINT "contratos_b2b_pkey" PRIMARY KEY (id);
...
ALTER TABLE "public"."contratos_b2b"
  ADD CONSTRAINT "contratos_b2b_organization_id_fkey" FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE SET NULL;
...
CREATE VIEW "public"."view_membros_equipe" WITH (security_invoker=true) AS  SELECT om.id AS vinculo_id,
    om.organization_id,
...
CREATE POLICY "Usuários veem suas organizações" ON "public"."organizations"
  FOR SELECT
  TO PUBLIC
...
GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."view_membros_equipe" TO "anon", "authenticated", "postgres", "service_role";
...
ALTER TABLE "public"."regras_categorizacao"
  ADD CONSTRAINT "regras_categorizacao_plano_contas_id_fkey" FOREIGN KEY (plano_contas_id) REFERENCES public.plano_contas(id);

ALTER TABLE "public"."transacoes"
  ADD CONSTRAINT "transacoes_plano_contas_id_fkey" FOREIGN KEY (plano_contas_id) REFERENCES public.plano_contas(id);

ALTER TABLE "public"."transacoes_staging"
  ADD CONSTRAINT "transacoes_staging_suggested_plano_contas_id_fkey" FOREIGN KEY (suggested_plano_contas_id) REFERENCES public.plano_contas(id);

CREATE VIEW "public"."vw_transacoes_staging" WITH (security_invoker=on) AS  SELECT ts.id,
    ts.organization_id,
    ts.conta_bancaria_id,
    cb.nome AS conta_bancaria_nome,
    ts.data_transacao,
    ts.valor,
    ts.descricao_original,
    ts.tipo_operacao,
    ts.status_importacao,
    ts.confidence_score,
    ts.suggested_plano_contas_id,
    (((pc.codigo_contabil)::text || ' - '::text) || pc.nome) AS suggested_plano_contas_nome,
    ts.suggested_centro_custo_id,
    cc.nome AS suggested_centro_custo_nome
   FROM (((public.transacoes_staging ts
     LEFT JOIN public.contas_bancarias cb ON ((ts.conta_bancaria_id = cb.id)))
     LEFT JOIN public.plano_contas pc ON ((ts.suggested_plano_contas_id = pc.id)))
     LEFT JOIN public.centros_custo cc ON ((ts.suggested_centro_custo_id = cc.id)))
  WHERE ((ts.status_importacao)::text = 'PENDENTE'::text);

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."vw_transacoes_staging" TO "anon", "authenticated", "postgres", "service_role";
...
CREATE VIEW "public"."vw_agendamentos" WITH (security_invoker=true) AS  SELECT t.id AS transacao_id,
    t.organization_id,
    t.conta_bancaria_id AS conta_id,
    c.nome AS nome_conta,
    c.tipo AS tipo_conta,
...
CREATE VIEW "public"."vw_contas_para_notificar" WITH (security_invoker=on) AS  SELECT t.id AS transacao_id,
    t.organization_id,
    o.nome AS nome_organizacao,
    t.descricao,
    t.valor,
...
CREATE VIEW "public"."vw_extrato_individual" WITH (security_invoker=true) AS  WITH extrato_bruto AS (
...
CREATE VIEW "public"."vw_transacoes_competencia" WITH (security_invoker=on) AS  SELECT t.id,
    t.organization_id,
    t.plano_contas_id,
    t.status,
...
GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."vw_agendamentos" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."vw_contas_para_notificar" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."vw_extrato_individual" TO "anon", "authenticated", "postgres", "service_role";

GRANT DELETE, INSERT, MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE "public"."vw_transacoes_competencia" TO "anon", "authenticated", "postgres", "service_role";
