...
Future<DTCrSinteticoStruct> getCrSinteticoPorId(
  String orgId,
  DateTime dataInicio,
  DateTime dataFim,
  String centroCustoId, // NOVO: O ID do departamento que desejamos auditar
) async {
  ...
  try {
    ...
    // Chamada apontada para a nova RPC dinâmica
    final response = await supabase.rpc(
      'fn_relatorio_cr_sintetico_por_id',
      params: {
        'p_org_id': orgId,
        'p_data_inicio': strInicio,
        'p_data_fim': strFim,
        'p_centro_custo_id':
            centroCustoId, // Filtro repassado ao banco de dados
      },
    );
