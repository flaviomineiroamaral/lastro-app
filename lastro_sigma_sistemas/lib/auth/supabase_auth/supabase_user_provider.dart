...
class LastroSigmaSistemasSupabaseUser extends BaseAuthUser {
  LastroSigmaSistemasSupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> lastroSigmaSistemasSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = LastroSigmaSistemasSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
