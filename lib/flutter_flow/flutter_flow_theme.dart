...
abstract class FlutterFlowTheme {
  ...
  late Color fundoText;
  late Color fundoText2;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFD68A1E);
  late Color secondary = const Color(0xFF1DB954);
  late Color tertiary = const Color(0xFF34495E);
  late Color alternate = const Color(0xFF262B32);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF8E949D);
  late Color primaryBackground = const Color(0xFF0F1115);
  late Color secondaryBackground = const Color(0xFF1A1D21);
  late Color accent1 = const Color(0xFFD68A1E);
  late Color accent2 = const Color(0xFF3D4449);
  ...
  late Color vibrantColor = const Color(0xFFE3B461);
  late Color lightVibrantColor = const Color(0xFFEAC785);
  late Color darkVibrantColor = const Color(0xFF513103);
  late Color mutedColor = const Color(0xFF978C75);
  late Color lightMutedColor = const Color(0xFFE2D6BC);
  late Color darkMutedColor = const Color(0xFF101010);
  late Color fundoText = const Color(0xFF3D4449);
  late Color fundoText2 = const Color(0xFF1F2937);
}
